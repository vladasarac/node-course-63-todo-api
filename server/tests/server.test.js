...
const {User} = require('./../models/user');//uvozimo model User iz server/models/user.js
...
//tesiranje PATCH rute /todos/:id za update todo-a
describe('PATCH /todos/:id', () => {
  it('should update the todo', (done) => {
    var hexId = todos[0]._id.toHexString();
    var text = 'This shuld be new text';
    request(app)
      .patch(`/todos/${hexId}`)
      .send({
        completed: true,
  ...
  it('should clear completed_at column when todo is not completed', (done) => {
    var hexId = todos[1]._id.toHexString();
    var text = 'This shuld be new text 2';
    request(app)
      .patch(`/todos/${hexId}`)
      .send({
        completed: false,
...
//testiranje rute koaj vadi trenutno ulgovanog usera
